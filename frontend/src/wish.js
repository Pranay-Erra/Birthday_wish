...
const Wishes = () => {
    ...
    useEffect(() => {
        ...
        return () => {
          ...
          // If you want to add the class back when the component is unmounted
    ...
    <link rel="icon" href="img/flowers.png" type="image/x-icon"></link>
    <div className={containerClass} id='roor'>
